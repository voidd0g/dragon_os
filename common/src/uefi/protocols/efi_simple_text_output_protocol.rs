use crate::uefi::data_types::{
    basic_types::{BOOLEAN, CHAR16, EFI_STATUS, UINTN},
    structs::simple_text_output_mode::SIMPLE_TEXT_OUTPUT_MODE,
};

type EFI_TEXT_RESET = unsafe extern "efiapi" fn(
    This: *const EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL,
    ExtendedVerification: BOOLEAN,
) -> EFI_STATUS;
type EFI_TEXT_STRING = unsafe extern "efiapi" fn(
    This: *const EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL,
    String: *const CHAR16,
) -> EFI_STATUS;
type EFI_TEXT_TEST_STRING = unsafe extern "efiapi" fn(
    This: *const EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL,
    String: *const CHAR16,
) -> EFI_STATUS;
type EFI_TEXT_QUERY_MODE = unsafe extern "efiapi" fn(
    This: *const EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL,
    ModeNumber: UINTN,
    ColumnsOut: *mut UINTN,
    Rows: *mut UINTN,
) -> EFI_STATUS;
type EFI_TEXT_SET_MODE = unsafe extern "efiapi" fn(
    This: *const EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL,
    ModeNumber: UINTN,
) -> EFI_STATUS;
type EFI_TEXT_SET_ATTRIBUTE = unsafe extern "efiapi" fn(
    This: *const EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL,
    Attribute: UINTN,
) -> EFI_STATUS;
type EFI_TEXT_CLEAR_SCREEN =
    unsafe extern "efiapi" fn(This: *const EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL) -> EFI_STATUS;
type EFI_TEXT_SET_CURSOR_POSITION = unsafe extern "efiapi" fn(
    This: *const EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL,
    Column: UINTN,
    Row: UINTN,
) -> EFI_STATUS;
type EFI_TEXT_ENABLE_CURSOR = unsafe extern "efiapi" fn(
    This: *const EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL,
    Visible: BOOLEAN,
) -> EFI_STATUS;
...
impl EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL {
    ...
    pub fn output_string(&self, string: &[CHAR16]) -> EFI_STATUS {
        unsafe { (self.OutputString)(self, string.as_ptr()) }
    }
}
