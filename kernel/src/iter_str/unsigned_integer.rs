...
use common::uefi::data_type::basic_type::{UnsignedInt16, UnsignedInt32, UnsignedInt64, UnsignedInt8, UnsignedIntNative};
		...
		impl $IterStrOf {
			pub fn new(value: $t, formatter: IterStrFormat) -> Self {
				...
				Self {
					...
					header_iter_opt,
					padding_letter,
					padding_rest: if padding_count > len { padding_count - len } else { 0 },
					cur_div: div,
					base,
				}
			}
